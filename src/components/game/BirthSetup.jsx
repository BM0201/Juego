  ...
  return (
    <section className="card">
      ...
      <div className="form-grid">
        <label>
          Siglo/rango
          <select value={centuryIndex} onChange={(e) => setCentury(Number(e.target.value))}>
      ...
      <button onClick={() => onSubmit({ year, month, day, century: selectedCentury.label })}>Continuar</button>
    </section>
  );
}
